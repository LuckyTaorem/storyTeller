story = {
    Start: {
        title: "Imagination",
        text: "You survey the battlefield that you've created. All sides have been at war for a long time, and also evenly matched. Who will win? It will all be decided on tonight.\n\n" +
            "\"Hey! It's time to go to bed!\" your Mom says, coming into your room.\n\n" +
            "Or at least it would be, if you didn't have to go to bed!\n\n" +
            "\"Aw Mom! I was just about to do something!\" you protest.\n\n" +
            "\"Well you can do something tomorrow, right now it's bedtime, you know the rules. But before you do, remember to brush your teeth and put these toys away.\"\n\n" +
            ...
            "Your Mom surveys everything you've set up. You have a myriad of unusual toys and figures standing next to each other. You have plastic knights standing next to spacemen defending a castle made of blocks on one side, while across from them is a combination of green army guys in vehicles and some metal robots. And yet on the far side of your room is another army set up consisting of dinosaurs and some other monsters. She just smiles at your creativeness.\n\n" +
            ...
            "After brushing your teeth, you head back to your room where you carefully step around the figures you've set up with care and get into bed. Of course, as usual, you don't fall asleep right away; you read a couple of pages of your favorite comic book first. Man, you wish real life wasn't as boring as it is. There's no magic, no superheroes, no giant robots, no nothing! You often wished you lived in a world with all of those things.\n\n" +
            "You turn off the lights in your room when your Mom checks on you again and demands you go to sleep. You're still a little too wound up to fall asleep though, so you just lie in your bed thinking how tomorrow's battle is going to play out.\n\n" +
            ...
            "You slowly peer out from under your covers, but unfortunately, this isn't the work of your imagination. These shadows ARE moving and now they're right by the side of your bed. Red dots form their eyes and a bluish light forms their grinning maws. Before you can cry out, one of them puts its hand over your mouth and puts its other hand to its own with its index finger to its lips. (Or rather where its lips would be if it had any)\n\n" +
            ...
            "Suddenly a purple portal opens up where your closet is, and two of the shadow creatures grab and carry you into it. The shadows run around you as you're carried down the green tunnel which the portal has led into. They excitedly talk about how their master will be pleased for getting you. Of course, all you're doing right now is panicking, and you start to struggle to get away. Surprisingly, you manage to break free of their grip and start trying to run back to where they entered this thing.\n\n" +
            ...
            "You yell and scream about how you wish you were back home as you fall through the endless void, and while that doesn't happen, you do suddenly appear someplace else...\n\n" +
    ...
    a: {
        text: "Upon entering you see many of the villagers just sitting outside their houses doing nothing, though a couple of them are lazily plucking some sort of stringed instruments. They barely pay any attention to you at all.\n\n" +
        ...
        choices: [{
                text: "Try to scare away the purple people",
                next: "b1"
            },
            {
                text: "Run back to tell Melcar",
                next: "b2"
            }
        ]
    },
    b1: {
        text: "You try to scare the little purple people much like you've ran after pigeons in the park, however the purple folks won't be chased away so easily, this is their home after all, they just nimbly get out of your way and continue to pelt you with stones, which are really starting to hurt at this point, and a particularly large stone smacks you in the head knocking you out.\n\n" +
            ...
            "\"Sadly no. While I can certainly understand and admire your judgment of wanting her to go with you, I cannot allow her to do so, as my mission will undoubtedly require her skills. As I said, I will send two of my men, but that is all I can spare if you decide to head back to the Empire.\"\n\n",
        choices: [{
                text: "Head back to the Empire",
                next: "c1"
            },
            {
                text: "Go with the Captain",
                next: "c2"
            }
        ]
    },
    b2: {
        text: "You aren't going to mess about with a bunch of angry little purple people; you don't know how dangerous they might be. You head back to the front of the house and knock on the door to get Melcar's help.\n\n" +
            ...
            "After Melcar runs off to go get his book, Chargrum demands an answer from you.\n\n" +
    ...
    c1: {
        text: "The sooner you're out of this place the better, so you request to be escorted back to the Empire where their wizards can send you back home.\n\n" +
    ...
    c2: {
        text: "You don't know anything about this place and you're in great danger, so you decide it would be best if you had as many people defending you as possible. You'd rather stay with the Captain.\n\n" +
        ...
        choices: [{
                text: "Go with the Adventurer",
                next: "d3"
            },
            {
                text: "Stick with the Captain",
                next: "d4"
            }
        ]
    },
    c3: {
        text: "You run up the stairs of the house, with Chargrum in pursuit.\n\n" +
        ...
        choices: [{
                text: "Use your power to try to escape",
                next: "d5"
            },
            {
                text: "Use your power to fight back",
                next: "d6"
            }
        ]
    },
    ...
    c4: {
        text: "Chargrum is your height so you think you can fight him off, however you're forgetting that he still has the strength of someone a lot older than you, he easily fends off your attack and grabs you by the scruff.\n\n" +
            "\"Stinky open the door! We gotta get rid of this Shadow magnet! NOW!\"\n\n" +
            "Stinky fumbles with the door while you protest and struggle, but it's no use, Chargrum has already thrown you outside to the Shadows.\n\n" +
    ...
    d1: {
        text: "You're in no position to fight a bunch of flying Shadows, you're not armed with anything, and nowhere near being a warrior. You take your horse in the direction that Lakri headed, leaving Salzat behind to fight the Shadows, though you aren't safe yet as a few of them are still in pursuit of you.\n\n" +
        ...
        choices: [{
                text: "Attempt to punch at the Shadow",
                next: "e1"
            },
            {
                text: "Hold on tight to the reins",
                next: "e2"
            }
        ]
    },
    d2: {
        text: "You jump off your horse to grab Lakri's sword in an effort to help Salzat who is already in the midst of battle, with the Shadow creatures who have almost completely enveloped him.\n\n" +
            "You swing the sword, but it's still a little too big and heavy for you to wield properly. You hit a few of the Shadows, but it's no use, they outnumber you greatly. Soon one of them manages to deprive you of your weapon and two more snatch you up and carry you up to the sky, giggling about how the Nightmare Tyrant is anxious to see you.\n\n" +
            "THE END",
            choices: [{
                text: "Restart",
                next: "Start"
    ...
    d3: {
        text: "You have to admit, even though you want to go back home, part of you really likes it here. Null sounds interesting and anyplace where the Shadows can't get you sounds even better. The Adventurer seems trustworthy enough, but you still hope you're making the right decision.\n\n" +
            "\"Okay, I'll go with you.\" you say a bit hesitantly.\n\n" +
            "\"Alright, let's get going, we still have quite a trip ahead of us.\"\n\n" +
    ...
    d4: {
        text: "While this man seems to mean well, you're still hesitant to just go wandering off with a stranger. Not that you aren't with some already, but you know the Captain and Lyssia a lot better than this Adventurer. Also you still feel safer with more people defending you, so you decline.\n\n" +
    ...
    d5: {
        text: "You attempt to wish yourself elsewhere again, but you failed to heed the warning given by Melcar who stated how such an action might be dangerous, and in this case it was…\n\n" +
    ...
    d6: {
        text: "You have to fight back, as escape is not an option. You don't even concentrate; you just wish you had something to defeat this creature!\n\n" +
            "Suddenly a glowing sword appears in your hand. You also feel somewhat different, as if you have been trained to use one before. The Shadow steps back a bit, but then attacks anyway. You take one swing at it and strike a powerful blow causing it to completely disappear.\n\n" +
        ...
        choices: [{
                text: "Barricade the house",
                next: "e7"
            },
            {
                text: "Destroy the Shadows",
                next: "e8"
            }
        ]
    },
    ...
    e1: {
        text: "With your free hand you attempt to punch the flying Shadow, but unfortunately it deftly dodges your attack and you unbalance yourself causing you to fall off the horse.\n\n" +
    ...
    e2: {
        text: "You pull away from the Shadow and hold on as tight as you can, hoping that somehow the horse can outrun these creatures, or at least hoping that someone can help you.\n\n" +
            "No sooner have you thought this, when suddenly you hear a sizzling sound followed by an ear-piercing screech from above. The Shadow trying to rip you from the horse has been struck down by some sort of bolt of lightning. Soon another Shadow is destroyed in the same way.\n\n" +
            ...
            "Eventually all the Shadows following you have been destroyed by bolts and you make it into the town, though you aren't sure of what to do or where to go next, but for now you're just glad to be alive. (Your horse has even calmed down a bit.)\n\n" +
            ...
            "The one who's helped you looks a little different from what you expected. This man looks more like a warrior, but not like the knights you encountered earlier. More like a barbarian type. He's bristling with muscles and has a large axe carried on his back.\n\n" +
            "\"You don't look like a Wizard.\" You say.\n\n" +
            "\"Of course I don't, because I'm not.\"\n\n" +
            "\"I thought only Wizards could cast spells.\"\n\n" +
            "\"Oh, that lightning bolt back there? That's thanks to this magic ring I found a long time ago. Though I think it's out of charges, it's useless except maybe to trade with now. Here, why don't you take it?\" He says giving you the ring.\n\n" +
            ...
            "Before you continue this conversation, you realize you don't really know the route to get to the Empire. The Paladins were supposed to lead you there and now both of them are gone. You don't know who else to ask, you're all by yourself again and this barbarian did help you, so you give it a shot…\n\n" +
            "\"Hey, um…could you help me get to the Empire? I don't exactly know the way.\"\n\n" +
    ...
    e3: {
        text: "You step forward towards him, an action that the Adventurer doesn't approve of at all.\n\n" +
            "\"What're you doing?!\"\n" +
    ...
    e4: {
        text: "From your world or not, something definitely isn't right here. In fact you begin pulling at the Adventurer wishing to leave. He concurs, but attempts to warn this person to stop following.\n\n" +
        ...
        choices: [{
                text: "Lose Johnny in Null, and then return to the Adventurer",
                next: "f3"
            },
            {
                text: "Attempt to reason with Johnny",
                next: "f4"
            }
        ]
    },
    e5: {
        text: "You have to get out of here! You crawl on the ground and lift up the bottom of one side of the tent and squeeze out. Unfortunately midway through your escape the Shadows see you and quickly drag the rest of you out of the tent and swarm you. You feel a paralyzing fear overwhelm your mind and the hideous laughter of the Nightmare Tyrant fill it.\n\n" +
    ...
    e6: {
        text: "You would think Lyssia would have extra weapons in her tent, but if she does she's currently using them all, because you can't find anything! Meanwhile Black Fang is being overwhelmed by Shadows and some of them are successfully ripping open the tent.\n\n" +
            "You wish you just had a weapon of some sort to fight them with…\n\n" +
            "Suddenly a glowing short sword appears in your hand. You're surprised at first, but when a Shadow comes at you from above, you waste your time in swinging your newly acquired weapon at it. The moment the sword touches the shadow, it dissolves and screeches before your eyes.\n\n" +
            "\"HEY, you got a sword how about helping me out over here!\" Black Fang shouts out noticing your actions while still fighting off the Shadows.\n\n" +
            ...
            "In the meantime, you settle down to sleep. Lyssia does as well while Black Fang takes watch since Lyssia points out that he was sleeping all day. Fortunately, the night is uneventful and when the morning comes you're on your way. Black Fang doesn't travel with you though; in fact, he pads off into a different direction.\n\n" +
            ...
            "As you and Lyssia travel, you and she exchange a bit of information about each others' respective worlds which you both find very interesting. You make a lot of progress in one day. So much that Lyssia mentions that you should reach the ruins by the next day. She says that she has orders to search the place as much as she can, and then return back to the Empire where you can get help from the wizards to send you back home. She hopes that the Captain and the rest of his soldiers are alright and will eventually reach the ruins themselves before she returns to the Empire. When night comes Black Fang makes his presence known again as you settle down to camp again.\n\n" +
            ...
            "\"Well there doesn't seem to be any more point in hiding, I'm pretty sure we can take them anyway.\" The thinner one says.\n\n" +
            ...
            "\"Run away pretty one if you value your existence, though I'd prefer if you didn't.\" Jarak says and attacks. He's incredibly quick and manages to hit Lyssia and knock her to the ground. A quick glance sees that Black Fang is struggling with Hago.\n\n" +
        ...
        choices: [{
                text: "Think of something to help your companions",
                next: "f5"
            },
            {
                text: "Think of something to directly harm the demons",
                next: "f6"
            }
        ]
    },
    e7: {
        text: "You might have new abilities, but they're still limited. Fighting a bunch of Shadows is just going to tire you and Melcar out and Melcar needs all of his energy to cast the portal spell.\n\n" +
    ...
    e8: {
        text: "You want to get home and away from this place as soon as possible. You feel with your sword and new abilities along with Melcar's help you should be able to take care of them.\n\n" +
            ...
            "You and Melcar begin to fight the Shadows, while Stinky goes off to hide, though it doesn't do him much good since the Shadows at this point are intent on not just getting you, but now everyone in the house, eventually all of his running and hiding attempts fail as you see him being dragged off by a few Shadows, you attempt to stop them, but nearly get yourself captured in the process.\n\n" +
    ...
    f1: {
        text: "If you knew that it was a simple wish that could get you home, you would've done it a long time ago! You begin to think really hard about going back home. You close your eyes and try to visualize it.\n\n" +
    ...
    f2: {
        ...
        choices: [{
                text: "Toss Qualan your sword",
                next: "g1"
            },
            {
                text: "Defeat Salzat yourself",
                next: "g2"
            }
        ]
    },
    f3: {
        text: "Given Johnny's seemingly relentless nature, it's useless to try to reason with him, so you continue to run. He isn't very fast so you figure you'll be able to lose him in the ruined City.\n\n" +
            ...
            "Before you can try to think of something to escape, one of the Forsaken knocks you unconscious with a rock.\n\n" +
    ...
    f4: {
        text: "You remember Null is filled with dangerous creatures as well, so you wouldn't be any safer going there by yourself and Johnny's likely to just keep following you no matter where you go. Maybe you can use your \"powers\" to reason with him.\n\n" +
            ...
            "\"I won't follow your evil commands anymore! From now on, I shall fight you with the very power you gave to me and your Shadows can't stop me!\" He shouts as he completely destroys two Shadows at the same time with one blow of his fist. While you're watching this the Shadows have become aware of your presence and are climbing over the edges of the floating rock.\n\n" +
            ...
            "\"You always did talk too much.\" Johnny says and summons up a bright blinding ball of light completely enveloping the entire area. You hear an unearthly bellow as you shield your eyes from the blinding light. When you open them again, you see Johnny standing before you.\n\n" +
            "\"Is he…\"\n\n" +
    ...
    f5: {
        text: "You wish for something that could help Lyssia and Black Fang, and at first nothing seems to happen, but Jarek then notices something when he tries to grab you and you dodge out of the way.\n\n" +
            ...
            "\"This is Zodan! I saw these symbols in the ruins I briefly explored. We have to go in and explore it. If the Nightmare Tyrant's minions are in there, who knows what secrets the Nightmare Tyrant might gain? We certainly don't want him to get any more powerful than he is!\"\n\n" +
            ...
            "\"Thanks for protecting me from the Shadows and demons.\"\n\n" +
            "\"Hey, you helped in both battles.\"\n\n" +
            ...
            "Lyssia and Black Fang quickly run out of the room. Lyssia shouts at you to continue your concentration.\n\n",
        choices: [{
                text: "Continue to concentrate for home",
                next: "g3"
            },
            {
                text: "Attempt to help",
                next: "g4"
            }
        ]
    },
    f6: {
        text: "You immediately concentrate on something that will hurt the demons, and your sword suddenly becomes a glowing blue axe. With Jarek approaching you strike at him and score a hit. He bellows in great pain, but it doesn't stop him from knocking you out with his quick reflexes.\n\n" +
    ...
    g1: {
        text: "Following Qualan's advice that he would do a better job at fighting Salzat you toss the sword to him and he meets Salzat's charge.\n\n" +
    ...
    g2: {
        text: "You have to defeat Salzat yourself. It was your thoughts that created the sword, by your own sheer force of willpower. If you believe in yourself, you'll be able to defeat Salzat, you know you will.\n\n" +
    ...
    g3: {
        text: "You were close last time to getting home, you can't stop now. Besides you have to do it quickly before the Shadows get inside!\n\n" +
    ...
    g4: {
        text: "You can't just abandon those who have helped you, and you wouldn't be able to concentrate anyway. You stand up and wish for something simpler and more immediate\n\n" +
